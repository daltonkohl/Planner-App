...
def main():
    """
    The main function that runs the Planner App
    """
    #creates the backend object initializing all variables
    back = Backend()
    #load the users with their username and passwords
    back.load()
    ...
    while(not valid):
        ...
        if(selection == "0"):
            ...
            while(not valid_user):
                ...
                #user is valid, sets check values to True
                else:
            ...
            while(not valid_input):
                ...
                #forces user to input valid selection
                ...
                while(removing):       
                    ...
                    if(type(rmvuser) == Student):
                        ...
                        for teacher in teachers:
                            #removes all instances of student from teacher's classes
                            teacher.remove_student_from_classes(rmvuser)
                    else:
                        students = back.get_students()
                        for student in students:
                            #for each class student has
                            for existing_class in student.get_class_list():
                                #if teacher of that class is the teacher to be removed
                                if(existing_class.get_teacher().get_name() == rmvuser.get_name()):
                                    #removes all instances of teacher from student classes
        ...
        #hidden slection to wipe both user databases
    ...
    while(doin_stuff):
        ...
        #add class
            ...
            while(not valid_name):
                ...
                #validates input is in form COMP 305
            ...
            while(not valid_date):
                ...
                #validates date is in form mm/dd/yyyy
